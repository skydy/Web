...
$.fn.quietflow = function(a) {
    ...
    function e() {
        for (var a = 0; h > a; a += x.squareSize + 1) for (var r = 0; c > r; r += x.squareSize + 1) S.fillStyle = randCol(x.maxRed, x.maxGreen, x.maxBlue, 1),
        S.fillRect(a, r, x.squareSize, x.squareSize);
        o(e)
    }
    function r() { (B + y > h || 0 > B + y) && (y = -y),
        (F + k > c || 0 > F + k) && (k = -k),
        B += y,
        F += k,
        S.fillStyle = x.backgroundCol,
        S.fillRect(0, 0, h, c);
        for (var a = 0; a < x.miniRadii; a++) for (var e = 0; e < x.miniRadii; e++) {
            ...
            S.beginPath(),
            S.fillStyle = x.circleCol,
            S.arc(t, l, i, 0, 2 * Math.PI, !0),
            S.closePath(),
            S.fill()
        }
        o(r)
    ...
    function t() {
        ...
        for (var a = 0; a < x.bounceBallCount; a++) {
            ...
            n = 3,
            s = 4,
            d = 5; (e[r] + e[n] > h || e[r] + e[n] < 0) && (e[3] = -e[3]),
            (e[l] + e[s] > c || e[l] + e[s] < 0) && (e[s] = -e[s]),
            e[r] += e[n],
            e[l] += e[s],
            S.beginPath(),
            S.fillStyle = e[d],
            S.arc(e[r], e[l], e[i], 0, 2 * Math.PI, !0),
            S.closePath(),
            S.fill()
        }
        o(t)
    ...
    function l() {
        ...
        S.fillRect(0, 0, h, c),
        S.beginPath(),
        S.fillStyle = x.lineColor,
        S.arc(f, m, 2, 0, 2 * Math.PI, !0),
        S.closePath(),
        S.fill();
        for (var a = 0; a < x.lines; a++) S.beginPath(),
        S.moveTo(f, m),
        S.lineTo(Math.random() * h, Math.random() * c),
        S.strokeStyle = x.lineColor,
        S.shadowColor = x.lineGlow,
        S.shadowBlur = 20,
        S.stroke();
        o(l)
    }
    function i() {
        ...
        for (var e = 0; e < P.length; e++) {
            ...
            r[t] += r[s],
            S.beginPath(),
            S.fillStyle = x.starColor,
            S.arc(r[t], r[l], r[n], 0, 2 * Math.PI, !0),
            S.shadowColor = "#FFF",
            S.shadowBlur = 20,
            S.closePath(),
            S.fill(),
            r[t] > h && (P.splice(e, 1), P.unshift([Math.random() * h / 4 - h / 4, Math.random() * c, Math.random() * x.starSize, Math.ceil(5 * Math.random())]))
        }
        o(i)
    }
    function n() {
        ...
        for (var a = [[0, 0], [h, 0], [0, c], [h, c]], e = 0; 4 > e; e++) {
            ...
            S.strokeStyle = x.specificColors.length > 0 ? x.specificColors[r] : randCol(255, 255, 255),
            S.moveTo(a[e][0], a[e][1]),
            S.lineTo(Math.random() * h, Math.random() * c)
        }
        S.shadowColor = x.lineGlow,
        S.shadowBlur = 20,
    ...
    function s() {
        ...
        for (var a = 0; a < q.length; a++) {
            ...
            n = 4;
            S.fillStyle = e[i],
            S.fillRect(e[r], e[t], e[l], e[l]),
            e[r] += e[n],
            e[t] -= e[n],
            (e[r] > h + x.maxBoxSize || e[t] < -x.maxBoxSize) && (q.splice(a, 1), 0 == x.specificColors.length ? q.push([Math.random() * h * 2 - h, Math.random() * c * 2 + c, Math.random() * x.maxBoxSize + 1, randCol(255, 255, 255, x.transparent ? .5 : 1), 5 * Math.random()]) : q.push([Math.random() * h * 2 - h, Math.random() * c * 2 + c, Math.random() * x.maxBoxSize + 1, x.specificColors[Math.floor(Math.random() * x.specificColors.length)], 5 * Math.random()]))
        }
        o(s)
    }
    var d = $(this),
    ...
    $(window).resize(function() {
        ...
        o = $("#Quietflow").css("1000").replace("px", "");
        $("#Quietflow").css({
    ...
    case "simpleGradient":
        ...
        z.addColorStop(0, x.primary),
        z.addColorStop(1, x.accent),
        S.fillStyle = z,
        S.fillRect(0, 0, h, c);
        break;
    case "starfield":
    ...
    case "layeredTriangles":
        S.fillStyle = x.backgroundCol,
        S.fillRect(0, 0, h, c);
        for (var R = 0; R < x.triangles; R++) S.beginPath(),
        S.moveTo(Math.random() * h, Math.random() * c),
        S.lineTo(Math.random() * h, Math.random() * c),
        S.lineTo(Math.random() * h, Math.random() * c),
        x.specificColors.length > 0 ? S.fillStyle = x.specificColors[Math.floor(Math.random() * x.specificColors.length)] : S.fillStyle = randCol(255, 255, 255, .5),
        S.closePath(),
        S.fill();
        break;
    case "cornerSpikes":
